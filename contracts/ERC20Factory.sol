...
contract ERC20Factory {
    ...
    event ERC20PegTokenRoleChanged(address token_address, address new_minter, address new_pauser);
    ...
    onlyRoot public returns (address token_address) {
        ...
        ERC20PegToken token = new ERC20PegToken{salt : salt}(name, symbol, decimals, minter, pauser);
    ...
    function changeTokenRole(address token_address, address new_minter, address new_pauser) onlyRoot public {
        ...
        emit ERC20PegTokenRoleChanged(token_address, new_minter, new_pauser);
    }
